      ...
      <div className="container mx-auto">
          ...
          <div className="flex flex-col gap-7 md:flex-row lg:flex-col">
            <div className="flex flex-col justify-between gap-6 rounded-xl bg-muted p-7 md:w-1/2 lg:w-auto">
              ...
              <div>
                ...
                <p className="text-secondary">{breakout.description}</p>
              </div>
        ...
        <div className="py-32">
          ...
          <div className="mt-8 overflow-hidden">
            <div className="glass-card bg-black/40 backdrop-blur-lg p-4 rounded-xl flex items-center gap-8 min-w-[200%] animate-company-marquee whitespace-nowrap">
        ...
        <div className="relative overflow-hidden rounded-xl glass-card bg-black/40 backdrop-blur-lg p-10 md:p-16">
          <div className="flex flex-col gap-4 text-center md:text-left">
            <h2 className="text-4xl font-semibold">{achievementsTitle}</h2>
            <p className="max-w-screen-sm text-secondary">
...
// Add this after the About3 component
