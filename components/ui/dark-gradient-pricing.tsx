  ...
  return (
    <div className="flex items-center gap-3">
      {checked ? (
        ...
        <span className="grid size-4 place-content-center rounded-full dark:bg-zinc-800 bg-zinc-200 text-sm dark:text-secondary text-secondary">
          <X className="size-3" />
        </span>
      )}
      <span className="text-sm dark:text-secondary text-secondary">{text}</span>
    </div>
  )
}
    ...
    >
      ...
      >
        <div className="flex flex-col items-center border-b pb-6 dark:border-zinc-700 border-zinc-200">
          <span className="mb-6 inline-block dark:text-zinc-50 text-secondary">
            {tier}
          </span>
